...
Call log:
  - waiting for getByRole('button', { name: 'Global Feed' })
    - locator resolved to <button class="nav-link "> Global Feed</button>
...
- generic [ref=e2]:
  ...
  - main [ref=e21]:
    - generic [ref=e22]:
      - generic [ref=e24]:
        - heading "New Article1775548965468" [level=1] [ref=e25]
        - generic [ref=e26]:
          ...
          - button " Edit Article" [ref=e34] [cursor=pointer]:
            - link " Edit Article" [ref=e35]:
              - /url: "#/editor/new-article1775548965468"
              - generic [ref=e36]: 
              - text: Edit Article
      - generic [ref=e37]:
        - generic [ref=e39]:
...
```ts
  ...
  21 |         this.yourFeedButton = this.page.getByRole('button', { name: 'Your Feed' });
  ...
  34 | 
  35 |     async globalFeed() {
> 36 |         await this.globalFeedButton.click();
     |                                     ^ Error: locator.click: Test timeout of 30000ms exceeded.
  37 |     }
  38 | 
