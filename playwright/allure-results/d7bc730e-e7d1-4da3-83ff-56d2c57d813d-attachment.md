...
Locator: locator('.article-preview .preview-link').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.article-preview .preview-link').first()
...
- generic [ref=e2]:
  ...
  - main [ref=e21]:
    - generic [ref=e22]:
      - generic [ref=e24]:
        - heading "New Article1775550793061" [level=1] [ref=e25]
        - generic [ref=e26]:
          ...
          - button " Edit Article" [ref=e34] [cursor=pointer]:
            - link " Edit Article" [ref=e35]:
              - /url: "#/editor/new-article1775550793061"
              - generic [ref=e36]: 
              - text: Edit Article
      - generic [ref=e37]:
        - generic [ref=e39]:
...
```ts
  ...
  224 |         await articlePage.globalFeed();
  225 |         await page.waitForLoadState('load');
> 226 |         await expect(articlePage.previewLink).toBeVisible();
      |                                               ^ Error: expect(locator).toBeVisible() failed
  227 |         await articlePage.addFavorite(data.article.title);
  228 |     });
  229 | });
```