...
```
TypeError: this.favoriteButton.click(...).first is not a function
```
...
- generic [ref=e2]:
  ...
  - main [ref=e21]:
    - generic [ref=e22]:
      - generic [ref=e24]:
        - heading "New Article1775550116256" [level=1] [ref=e25]
        - generic [ref=e26]:
          ...
          - button " Edit Article" [ref=e34] [cursor=pointer]:
            - link " Edit Article" [ref=e35]:
              - /url: "#/editor/new-article1775550116256"
              - generic [ref=e36]: 
              - text: Edit Article
      - generic [ref=e37]:
        - generic [ref=e39]:
...
> 40 |         await this.favoriteButton.click().first();
     |                                   ^ Error: locator.click: Test ended.
  41 |     }
  42 | 
  43 |     async unFavorite() {
