...
Call log:
  - waiting for locator('.nav-link active').getByRole('button', { name: 'Global Feed' })
...
- generic [ref=e2]:
  ...
  - main [ref=e21]:
    - generic [ref=e22]:
      - generic [ref=e24]:
        - heading "New Article1775549027446" [level=1] [ref=e25]
        - generic [ref=e26]:
          ...
          - button " Edit Article" [ref=e34] [cursor=pointer]:
            - link " Edit Article" [ref=e35]:
              - /url: "#/editor/new-article1775549027446"
              - generic [ref=e36]: 
              - text: Edit Article
      - generic [ref=e37]:
        - generic [ref=e39]:
...
```ts
  ...
  22 |         this.globalFeedButton = this.page.locator('.nav-link active').getByRole('button', { name: 'Global Feed' });
